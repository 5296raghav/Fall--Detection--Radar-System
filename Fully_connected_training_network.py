...
X = sio.loadmat('C:\\Users\\Shan\\Downloads\\Fall_Detection\\ts.mat')
X=X['Data']
import csv
with open('C:\\Users\\Shan\\Downloads\\Fall_Detection\\lab.csv', 'r') as mf:
...
#conv4 = keras.layers.Convolution1D(50, 1, padding='same')(conv3)
...
predict = model.predict(x_train[1].reshape((1,) +x_train[1].shape))
print(predict)
# type(x_test[0])
